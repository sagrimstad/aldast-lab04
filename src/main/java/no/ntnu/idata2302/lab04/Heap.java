...
public class Heap {
   ...
   * <p>
   * The heap is sorted after the insertion by going through each parent node from the inserted node
   * and using bubble up operations if necessary.
   *
   * @param k A specified value to be inserted.
   */
